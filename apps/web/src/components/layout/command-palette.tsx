...
const navigationItems = [
  ...
  { label: "Go to Messages", to: "/messages", icon: Inbox },
  ...
  { label: "Go to Hygiene", to: "/hygiene", icon: SprayCan },
  { label: "Go to Maintenance", to: "/maintenance", icon: Wrench },
  { label: "Go to Housekeeping", to: "/housekeeping", icon: BedDouble },
